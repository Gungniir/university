...
public class CommandIndexBuilding: ICommand
{
    ...
    public string Signature { get; } = "building:index";
    public string Description { get; } = "Отобразить список всех зданий";

    private readonly IDatabase _db;

    public CommandIndexBuilding(IDatabase db)
    {
        _db = db;
    }
    ...
    public void Run()
    {
        Table table = new Table
            ...
            foreach (Building building in _db.SelectAllBuildings())
            {
